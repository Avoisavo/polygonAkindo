    ...
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen">
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold text-gray-900">BeeBot</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-200">
        <button className="w-full flex items-center gap-3 px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors">
          ...
          <div className="flex-1 text-left">
            <div className="text-sm font-medium text-gray-900">Judha Maygustya</div>
            <div className="text-xs text-gray-500">judha.design@gmail.com</div>
          </div>
        </button>
      </div>
    </div>
