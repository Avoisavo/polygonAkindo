                ...
                >
                  <div
                    className={`max-w-[80%] rounded-2xl px-4 py-3 ${
                      msg.role === 'user'
                        ? 'bg-linear-to-r from-gray-800 to-black text-white'
                  ...
                  >
                    ...
                    {msg.paymentInfo && (
                      <div className="mt-3 space-y-2 rounded-lg border border-green-200 bg-green-50 p-3">
                        <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-green-800">
                        ...
                        <div className="space-y-1 text-xs">
                          <div className="flex justify-between">
                            ...
                            <span className="font-mono font-bold text-green-700">{msg.paymentInfo.amount}</span>
                          </div>
                          <div className="flex justify-between">
                        ...
                        <div className="pt-2 text-xs italic text-gray-600">
                    ...
                    {msg.paymentRequest && (
                      <div className="mt-3 space-y-3 rounded-lg border border-blue-200 bg-blue-50 p-3">
                        ...
                        <div className="space-y-2 text-xs">
                          <div className="flex justify-between">
                            <span className="text-gray-600">Amount:</span>
                            <span className="font-bold text-gray-900">{msg.paymentRequest.payment.price}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Network:</span>
                            <span className="text-gray-900">{msg.paymentRequest.payment.network}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Description:</span>
                            <span className="text-gray-900">{msg.paymentRequest.payment.description}</span>
                          </div>
                        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-3">
                ...
                <button
                  ...
                  className="p-2 bg-linear-to-r from-gray-800 to-black rounded-lg hover:from-gray-700 hover:to-gray-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
